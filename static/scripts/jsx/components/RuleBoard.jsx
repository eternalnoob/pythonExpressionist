...
var RuleBoard = React.createClass({
  ...
  render: function() {
    ...
    <div>
      ...
      <div>
      <h3>{this.props.name} -> {this.props.expansion}</h3><Button bsStyle="danger" onClick={this.props.onDeleteRule}><Glyphicon glyph="warning-sign"/>Delete</Button>
      </div>

      <h2>{this.props.app_rate}</h2>

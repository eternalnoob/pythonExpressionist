...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nonterminal = __webpack_require__(158);
	var Rule = __webpack_require__(160);
	...
	var nonterminal = { name: "TEST_NONTERMINAL", rules: [{ expansion: "testExpand", app_rate: 5 }, { expansion: "test1", app_rate: 3 }], markup: ["test", "test2"] };

	_reactDom2["default"].render(_react2["default"].createElement(Nonterminal, nonterminal), document.getElementById('button_list'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RuleBar = __webpack_require__(159);

	var Nonterminal = React.createClass({
	  displayName: 'Nonterminal',
	  ...
	  render: function render() {
	    {/*
	      ...
	      */}
	    return React.createElement(RuleBar, { rules: this.props.rules });
	  }
	...
	var RuleBar = React.createClass({
	  ...
	  render: function render() {
	    ...
	    this.props.rules.forEach(function (rule, i) {
	      rules.push(React.createElement('rule', _extends({}, rule, { key: i })));
	    }, this);
